...
public class PruebaAritmetica {
    ...
    public static void main(String[] args) {
        ...
        int b = 7; // memoria stack (variables locales
    ...
    //modlaridad creamos un nvo metodo
    public static void miMetodo() {
        //a = 10; es una varialbe local, no tiene el alcance para ser utlizada ( su alcance es dentro de un metodo)
